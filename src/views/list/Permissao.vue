      ...
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-3">
                <router-link to="/Permissao/Novo" class="btn btn-success">
                  Nova Permissao
                </router-link>
              </div>
              <div class="col-9">
            ...
            <table class="table table-hover table-striped table-sm">
              ...
              <tbody v-if="this.dados.length >= 1">
                <tr v-for="(item, i) in this.dados" :key="i">
                  ...
                  <td>
                    <router-link
                      :to="{ path: '/Permissao/Editar/' + item.id }"
              ...
              <tbody v-else>
                <tr>
                  <td colspan="5" align="center">Nenhuma permissão encontrado</td>
                </tr>
              </tbody>
            </table>
          </div>
  ...
  methods: {
    pesquisar() {
      if (this.query == "") {
        ...
        Conexao.get("/Permissao/PesquisarPermissao/" + this.query).then(
          (resposta) => {
    ...
    excluir(item) {
      console.log("teste");
      Conexao.delete("/Permissao/" + item.id)
        .then((resposta) => {
          if (resposta.data.isOk) {
            this.startData();
          } else {
